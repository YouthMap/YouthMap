...
class MapHandler(BaseHandler):
    ...
    def get(self):
        ...
        temp_stations = json.dumps(get_temporary_stations_for_user_frontend(self.application.db))
        perm_stations = json.dumps(get_permanent_stations_for_user_frontend(self.application.db))
